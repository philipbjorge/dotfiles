# Generated by Powerlevel10k configuration wizard on 2023-03-17 at 04:24 UTC.
...
# fluent, transient_prompt, instant_prompt=auto-quiet.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{10}'
      local   modified='%F{11}'
      local  untracked='%F{14}'
      local conflicted='%F{9}'
    else
